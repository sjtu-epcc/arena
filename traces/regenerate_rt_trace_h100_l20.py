        ...
        while not is_feasible:
            ...
            for _i, _threshold in enumerate(prob_list_gpu_type):
                if _type_idx < _threshold:
                    _gpu_type = supported_gpu_type[_i]
                    break
...
if __name__ == "__main__":
    if args.visualize_raw_trace:
        ...
        target_pth = "./traces/runtime_trace_revision.csv" if not args.dummy_test \
                        else "./traces/dummy_runtime_trace_revision.csv"
