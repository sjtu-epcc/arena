...
(Modified by Crius) we modify "find_library(CUPTI_LIBRARY cupti ...)" to
"find_library(CUPTI_LIBRARY libcupti.so)" and "${CUPTI_DIR}/lib/x64" to "${CUPTI_DIR}/lib64"
...
find_library(CUPTI_LIBRARY libcupti.so
  HINTS
  ${CUPTI_DIR}/lib64
