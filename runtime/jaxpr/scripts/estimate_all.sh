...
do
    ...
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
...
do
    ...
    # Profile Wide-ResNet (1B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name wide_resnet --param_num 1B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
    #                               --num_devices_per_host 2 --model_name wide_resnet --param_num 1B \
    #                               --batch_size ${batch_size}
    # Profile Wide-ResNet (2B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name wide_resnet --param_num 2B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
    #                               --num_devices_per_host 2 --model_name wide_resnet --param_num 2B \
    #                               --batch_size ${batch_size}
    ...
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name wide_resnet --param_num 4B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
...
do
    ...
    # Profile Bert (1.3B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name bert --param_num 1.3B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
    #                               --num_devices_per_host 2 --model_name bert --param_num 1.3B \
    #                               --batch_size ${batch_size}
    # Profile Bert (2.6B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name bert --param_num 2.6B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
    #                               --num_devices_per_host 2 --model_name bert --param_num 2.6B \
    #                               --batch_size ${batch_size}
    # Profile Bert (6.7B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name bert --param_num 6.7B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
...
do
    ...
    # Profile MoE (1.3B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name moe --param_num 1.3B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
    #                               --num_devices_per_host 2 --model_name moe --param_num 1.3B \
    #                               --batch_size ${batch_size}
    # Profile MoE (2.4B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name moe --param_num 2.4B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
    #                               --num_devices_per_host 2 --model_name moe --param_num 2.4B \
    #                               --batch_size ${batch_size}
    # Profile MoE (10B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a100 --num_hosts 1 \
                                  --num_devices_per_host 4 --model_name moe --param_num 10B \
                                  --batch_size ${batch_size}
    # python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
...
do
    ...
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
                                  --num_devices_per_host 4 --model_name wide_resnet --param_num 6.8B \
                                  --batch_size ${batch_size}
done
...
do
    ...
    # Profile Bert (15B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
                                  --num_devices_per_host 4 --model_name bert --param_num 15B \
                                  --batch_size ${batch_size}
done
...
do
    ...
    # Profile MoE (27B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a100 --num_hosts 2 \
                                  --num_devices_per_host 4 --model_name moe --param_num 27B \
                                  --batch_size ${batch_size}
done
