...
do
    ...
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a10 --num_hosts 1 \
...
do
    ...
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 1_a10 --num_hosts 1 \
                                  ...
                                  --batch_size ${batch_size}
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a10 --num_hosts 2 \
                                  --num_devices_per_host 1 --model_name wide_resnet --param_num 500M \
                                  --batch_size ${batch_size}
...
do
    ...
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a10 --num_hosts 2 \
                                  --num_devices_per_host 2 --model_name wide_resnet --param_num 500M \
                                  --batch_size ${batch_size}
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 4_a10 --num_hosts 4  \
                                  --num_devices_per_host 1 --model_name wide_resnet --param_num 500M \
                                  --batch_size ${batch_size}
    # Profile Wide-ResNet (1B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 2_a10 --num_hosts 2 \
...
do
    batch_size=${batch_size_list[${i}]}
    # Profile Wide-ResNet (500M)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 8_a10 --num_hosts 8  \
                                  --num_devices_per_host 2 --model_name wide_resnet --param_num 500M \
                                  --batch_size ${batch_size}
    # Profile Wide-ResNet (1B)
    python jaxpr/crius_profile.py --estimate_e2e --profile_all_configs --devices_name 8_a10 --num_hosts 8  \
